...
class SwiftPackageManagerTests: XCTestCase {
    ...
    func testDecoding() throws {
        ...
        XCTAssertEqual(package.repositoryURL, URL(string: "https://github.com/ishkawa/APIKit.git"))
    ...
    func testDecodingOfURLWithDots() throws {
        ...
        XCTAssertEqual(package.repositoryURL, URL(string: "https://github.com/mac-cain13/R.swift.Library"))
    ...
    func testConvertToGithub() {
        let package = SwiftPackage(package: "Commander",
                                   repositoryURL: URL(string: "https://github.com/kylef/Commander.git")!,
    ...
    func testConvertToGithubNameWithDots() {
        let package = SwiftPackage(package: "R.swift.Library",
                                   repositoryURL: URL(string: "https://github.com/mac-cain13/R.swift.Library")!,
    ...
    func testConvertToGithubSSH() {
        let package = SwiftPackage(package: "LicensePlist",
                                   repositoryURL: URL(string: "git@github.com:mono0926/LicensePlist.git")!,
    ...
    func testConvertToGithubPackageName() {
        let package = SwiftPackage(package: "IterableSDK",
                                   repositoryURL: URL(string: "https://github.com/Iterable/swift-sdk")!,
                                   state: SwiftPackage.State(branch: nil, revision: "3365947d725398694d6ed49f2e6622f05ca3fc0e", version: nil))
        let result = package.toGitHub(renames: [:])
    ...
    func testInvalidURL() {
        let package = SwiftPackage(package: "Google", repositoryURL: URL(string: "http://www.google.com")!, state: SwiftPackage.State(branch: nil, revision: "", version: "0.0.0"))
        let result = package.toGitHub(renames: [:])
        XCTAssertNil(result)
    }
    ...
    func testNonGithub() {
        let package = SwiftPackage(package: "Bitbucket",
                                   repositoryURL: URL(string: "https://mbuchetics@bitbucket.org/mbuchetics/adventofcode2018.git")!,
    ...
    func testParse() throws {
        ...
        XCTAssertEqual(packageFirst, SwiftPackage(package: "APIKit",
                                                  repositoryURL: URL(string: "https://github.com/ishkawa/APIKit.git")!,
        ...
        XCTAssertEqual(packageLast, SwiftPackage(package: "Yaml",
                                                 repositoryURL: URL(string: "https://github.com/behrang/YamlSwift.git")!,
